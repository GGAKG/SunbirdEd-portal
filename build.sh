...
build_server(){
    ...
    cp -R libs helpers proxy resourcebundles package.json framework.config.js sunbird-plugins routes tenant constants controllers server.js ./../../Dockerfile app_dist
    cd app_dist
    nvm use $NODE_VERSION
